...
object ClubOwnGoalsAnalysis {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val clubGoals = joinedDF
      .groupBy("name")
      .sum("opponent_goals")
      .withColumnRenamed("sum(opponent_goals)", "opponent_goals")


    // 按照总进球数降序排序，并选择前十名
    val top10Clubs = clubGoals.orderBy(desc("opponent_goals"))
      .limit(11)
    ...
    top10Clubs.write
      ...
      .jdbc(mysqlUrl, "ClubOwnGoalsAnalysis", mysqlProperties)
